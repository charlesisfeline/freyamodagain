...
class FreeplayState extends MusicBeatSubState
{
  ...
  override function create():Void
  {
    ...
    pinkBack.color = 0xFFD17D00; // sets it to pink!
    ...
    funnyScroll = new BGScrollingText(0, 220, 'FREYAFENNECFOXES', FlxG.width / 2, false, 60);
    ...
    funnyScroll3 = new BGScrollingText(0, orangeBackShit.y + 10, 'CHECK OUT JIMBOJIMMY', FlxG.width / 2, 60);
    ...
    // TODO: Replace this.
    if (currentCharacter == 'pico' || currentCharacter == 'tankman') dj.visible = false;
...
class FreeplaySongData
{
  ...
  public inline function getPreviewTiming():Array<Float>
    return [
      song._data.playData.previewStart / 100000,
      song._data.playData.previewEnd / 100000
    ]; // 100000 = ms -> seconds
